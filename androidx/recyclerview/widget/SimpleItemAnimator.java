...
public abstract class SimpleItemAnimator extends ItemAnimator
{
    ...
    @Override
    public boolean animateAppearance(final ViewHolder viewHolder, final ItemHolderInfo itemHolderInfo, final ItemHolderInfo itemHolderInfo2) {
    ...
    @Override
    public boolean animateChange(final ViewHolder viewHolder, final ViewHolder viewHolder2, final ItemHolderInfo itemHolderInfo, final ItemHolderInfo itemHolderInfo2) {
    ...
    @Override
    public boolean animateDisappearance(final ViewHolder viewHolder, final ItemHolderInfo itemHolderInfo, final ItemHolderInfo itemHolderInfo2) {
        final int left = itemHolderInfo.left;
        final int top = itemHolderInfo.top;
    ...
    @Override
    public boolean animatePersistence(final ViewHolder viewHolder, final ItemHolderInfo itemHolderInfo, final ItemHolderInfo itemHolderInfo2) {
