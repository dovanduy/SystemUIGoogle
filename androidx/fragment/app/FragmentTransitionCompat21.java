...
class FragmentTransitionCompat21 extends FragmentTransitionImpl
{
    ...
    public void scheduleHideFragmentView(final Object o, final View view, final ArrayList<View> list) {
        ((Transition)o).addListener((Transition$TransitionListener)new Transition$TransitionListener(this) {
    ...
    public void setEpicenter(final Object o, final Rect rect) {
        if (o != null) {
            ((Transition)o).setEpicenterCallback((Transition$EpicenterCallback)new Transition$EpicenterCallback(this) {
    ...
    public void setEpicenter(final Object o, final View view) {
        if (view != null) {
            ...
            transition.setEpicenterCallback((Transition$EpicenterCallback)new Transition$EpicenterCallback(this) {
                public Rect onGetEpicenter(final Transition transition) {
                    return rect;
                }
            });
