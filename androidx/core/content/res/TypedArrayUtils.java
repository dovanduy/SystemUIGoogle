...
public class TypedArrayUtils
{
    ...
    public static ColorStateList getNamedColorStateList(final TypedArray typedArray, final XmlPullParser xmlPullParser, final Resources$Theme resources$Theme, final String s, final int i) {
        if (!hasAttribute(xmlPullParser, s)) {
            return null;
        }
        ...
        if (type >= 28 && type <= 31) {
            return getNamedColorStateListFromInt(obj);
        }
        return ColorStateListInflaterCompat.inflate(typedArray.getResources(), typedArray.getResourceId(i, 0), resources$Theme);
    }
