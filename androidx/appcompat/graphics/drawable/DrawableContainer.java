...
class DrawableContainer extends Drawable implements Drawable$Callback
{
    ...
    private void initializeDrawableForDisplay(final Drawable drawable) {
        ...
        final BlockInvalidateCallback mBlockInvalidateCallback = this.mBlockInvalidateCallback;
        mBlockInvalidateCallback.wrap(drawable.getCallback());
        drawable.setCallback((Drawable$Callback)mBlockInvalidateCallback);
        try {
            ...
            if (sdk_INT >= 21 && mHotspotBounds != null) {
    ...
    private boolean needsMirroring() {
        ...
        boolean b = true;
        if (!autoMirrored || DrawableCompat.getLayoutDirection(this) != 1) {
            b = false;
        }
        return b;
    }
    ...
    abstract static class DrawableContainerState extends Drawable$ConstantState
    {
        ...
        final boolean setLayoutDirection(final int n, final int n2) {
            ...
            boolean b;
            boolean b2;
            for (int i = (b = false) ? 1 : 0; i < mNumChildren; ++i, b = b2) {
                b2 = b;
                if (mDrawables[i] != null) {
                    final boolean b3 = Build$VERSION.SDK_INT >= 23 && mDrawables[i].setLayoutDirection(n);
                    b2 = b;
                    if (i == n2) {
                        b2 = b3;
                    }
