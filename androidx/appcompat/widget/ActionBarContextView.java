...
public class ActionBarContextView extends AbsActionBarView
{
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(R$id.action_mode_close_button).setOnClickListener((View$OnClickListener)new View$OnClickListener(this) {
        ...
        (super.mActionMenuPresenter = new ActionMenuPresenter(this.getContext())).setReserveOverflow(true);
        final ViewGroup$LayoutParams viewGroup$LayoutParams = new ViewGroup$LayoutParams(-2, -1);
        menuBuilder.addMenuPresenter(super.mActionMenuPresenter, super.mPopupContext);
        ViewCompat.setBackground((View)(super.mMenuView = (ActionMenuView)super.mActionMenuPresenter.getMenuView(this)), null);
        this.addView((View)super.mMenuView, viewGroup$LayoutParams);
    }
