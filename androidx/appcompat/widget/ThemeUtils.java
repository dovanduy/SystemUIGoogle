...
public class ThemeUtils
{
    ...
    public static void checkAppCompatTheme(final View view, Context obtainStyledAttributes) {
        obtainStyledAttributes = (Context)obtainStyledAttributes.obtainStyledAttributes(R$styleable.AppCompatTheme);
        try {
            if (!((TypedArray)obtainStyledAttributes).hasValue(R$styleable.AppCompatTheme_windowActionBar)) {
    ...
    public static ColorStateList getThemeAttrColorStateList(Context obtainStyledAttributes, final int n) {
        final int[] temp_ARRAY = ThemeUtils.TEMP_ARRAY;
        temp_ARRAY[0] = n;
        obtainStyledAttributes = (Context)TintTypedArray.obtainStyledAttributes(obtainStyledAttributes, null, temp_ARRAY);
        try {
