...
class AppCompatTextViewAutoSizeHelper
{
    ...
    private static <T> T accessAndReturnWithDefault(Object value, final String str, final T t) {
        try {
    ...
    private StaticLayout createStaticLayoutForMeasuring(final CharSequence charSequence, final Layout$Alignment alignment, int maxLines, final int n) {
        final StaticLayout$Builder obtain = StaticLayout$Builder.obtain(charSequence, 0, charSequence.length(), this.mTempTextPaint, maxLines);
    ...
    private int findLargestTextSizeWhichFits(final RectF rectF) {
        ...
        if (length != 0) {
            ...
            while (i <= length) {
                n = (i + length) / 2;
                if (this.suggestedSizeFitsInSpace(this.mAutoSizeTextSizesInPx[n], rectF)) {
                    final int n2 = n + 1;
                    n = i;
                    i = n2;
                }
    ...
    private static <T> T invokeAndReturnWithDefault(Object obj, final String str, T invoke) {
        try {
            try {
                ...
                if (this.mTextView.getMeasuredHeight() > 0) {
                    if (this.mTextView.getMeasuredWidth() > 0) {
                        ...
                        if (Build$VERSION.SDK_INT >= 29) {
                            ...
                            b = invokeAndReturnWithDefault(this.mTextView, "getHorizontallyScrolling", Boolean.FALSE);
                        }
                        int n;
                        if (b) {
                            n = 1048576;
    ...
    void loadFromAttributes(final AttributeSet set, int resourceId) {
        ...
        ViewCompat.saveAttributeDataForStyleable((View)mTextView, mTextView.getContext(), R$styleable.AppCompatTextView, set, obtainStyledAttributes, resourceId, 0);
