...
public class AppCompatImageHelper
{
    ...
    public void loadFromAttributes(final AttributeSet set, int resourceId) {
        ...
        ViewCompat.saveAttributeDataForStyleable((View)mView, mView.getContext(), R$styleable.AppCompatImageView, set, obtainStyledAttributes.getWrappedTypeArray(), resourceId, 0);
        try {
            Drawable drawable2;
