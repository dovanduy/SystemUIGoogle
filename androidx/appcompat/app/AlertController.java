...
class AlertController
{
    ...
    public AlertController(final Context mContext, final AppCompatDialog mDialog, final Window mWindow) {
        ...
        this.mButtonHandler = (View$OnClickListener)new View$OnClickListener() {
            public void onClick(final View view) {
                final AlertController this$0 = AlertController.this;
                Message message = null;
                Label_0092: {
                    if (view == this$0.mButtonPositive) {
                        final Message mButtonPositiveMessage = this$0.mButtonPositiveMessage;
                        if (mButtonPositiveMessage != null) {
                            message = Message.obtain(mButtonPositiveMessage);
                            break Label_0092;
                        }
                    }
                    final AlertController this$2 = AlertController.this;
                    if (view == this$2.mButtonNegative) {
                        final Message mButtonNegativeMessage = this$2.mButtonNegativeMessage;
                        if (mButtonNegativeMessage != null) {
                            message = Message.obtain(mButtonNegativeMessage);
                            break Label_0092;
                        }
                    }
                    final AlertController this$3 = AlertController.this;
                    if (view == this$3.mButtonNeutral) {
                        final Message mButtonNeutralMessage = this$3.mButtonNeutralMessage;
                ...
                final AlertController this$4 = AlertController.this;
                this$4.mHandler.obtainMessage(1, (Object)this$4.mDialog).sendToTarget();
            }
        };
        ...
        if (Build$VERSION.SDK_INT >= 23) {
            ...
            if (view != null || view2 != null) {
                if (this.mMessage != null) {
                    this.mScrollView.setOnScrollChangeListener((NestedScrollView.OnScrollChangeListener)new NestedScrollView.OnScrollChangeListener(this) {
                        @Override
                    ...
                    if (mListView != null) {
                        mListView.setOnScrollListener((AbsListView$OnScrollListener)new AbsListView$OnScrollListener(this) {
    ...
    private void setupButtons(final ViewGroup viewGroup) {
        ...
        if (TextUtils.isEmpty(this.mButtonNeutralText) && this.mButtonNeutralIcon == null) {
            ...
            final Drawable mButtonNeutralIcon = this.mButtonNeutralIcon;
            if (mButtonNeutralIcon != null) {
                final int mButtonIconDimen3 = this.mButtonIconDimen;
                mButtonNeutralIcon.setBounds(0, 0, mButtonIconDimen3, mButtonIconDimen3);
                ...
                if (this.mCursor == null) {
                    mAdapter = new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) {
                        public View getView(final int n, View view, final ViewGroup viewGroup) {
                            ...
                            final boolean[] mCheckedItems = AlertParams.this.mCheckedItems;
                ...
                mListView.setOnItemClickListener((AdapterView$OnItemClickListener)new AdapterView$OnItemClickListener() {
                    public void onItemClick(final AdapterView<?> adapterView, final View view, final int n, final long n2) {
                        ...
                        if (mCheckedItems != null) {
                            mCheckedItems[n] = mListView.isItemChecked(n);
                        }
