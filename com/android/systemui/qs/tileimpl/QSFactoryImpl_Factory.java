...
public final class QSFactoryImpl_Factory implements Factory<QSFactoryImpl>
{
    ...
    public static QSFactoryImpl provideInstance(final Provider<QSHost> provider, final Provider<WifiTile> provider2, final Provider<BluetoothTile> provider3, final Provider<CellularTile> provider4, final Provider<DndTile> provider5, final Provider<ColorInversionTile> provider6, final Provider<AirplaneModeTile> provider7, final Provider<WorkModeTile> provider8, final Provider<RotationLockTile> provider9, final Provider<FlashlightTile> provider10, final Provider<LocationTile> provider11, final Provider<CastTile> provider12, final Provider<HotspotTile> provider13, final Provider<UserTile> provider14, final Provider<BatterySaverTile> provider15, final Provider<DataSaverTile> provider16, final Provider<NightDisplayTile> provider17, final Provider<NfcTile> provider18, final Provider<GarbageMonitor.MemoryTile> provider19, final Provider<UiModeNightTile> provider20, final Provider<ScreenRecordTile> provider21) {
        return new QSFactoryImpl(DoubleCheck.lazy(provider), provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14, provider15, provider16, provider17, provider18, provider19, provider20, provider21);
    }
