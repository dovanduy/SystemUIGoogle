...
public final class SystemUIDefaultModule_ProvideHeadsUpManagerPhoneFactory implements Factory<HeadsUpManagerPhone>
{
    ...
    public static SystemUIDefaultModule_ProvideHeadsUpManagerPhoneFactory create(final Provider<Context> provider, final Provider<StatusBarStateController> provider2, final Provider<KeyguardBypassController> provider3, final Provider<NotificationGroupManager> provider4, final Provider<ConfigurationController> provider5) {
    ...
    public static HeadsUpManagerPhone proxyProvideHeadsUpManagerPhone(final Context context, final StatusBarStateController statusBarStateController, final KeyguardBypassController keyguardBypassController, final NotificationGroupManager notificationGroupManager, final ConfigurationController configurationController) {
        final HeadsUpManagerPhone provideHeadsUpManagerPhone = SystemUIDefaultModule.provideHeadsUpManagerPhone(context, statusBarStateController, keyguardBypassController, notificationGroupManager, configurationController);
